...
<body>
    <div class="logo-text">
        <img src="/cdn/uthin/covers_assets/w2407-m-3-pure-flow/images/logo-07.webp" alt="">
    </div>
    <hr />
    <div class="div-wrapper">

        <div class="image-product">
            <img src="/cdn/uthin/covers_assets/w2407-m-3-pure-flow/images/Pure-Flow-Matcha.webp" class="product" />
        </div>
